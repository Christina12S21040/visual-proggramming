...
public class T05 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(toFixed(dataBuku(kodeISBN, hargaBuku, totalEksemplar),2));
        dataBukuPertama();
    }
    
    public static double dataBuku(String[] kodeISBN, double[] hargaBuku, int[] totalEksemplar) {
    ...
    public static void dataBukuPertama() {
    }
